...
* [Computational Methods for Astronomy](https://github.com/sbustamante/ComputationalMethods)
* [Cookiecutter template for a simple jupyter book](https://github.com/executablebooks/cookiecutter-jupyter-book)
* [Open source book about making Python packages](https://github.com/py-pkgs/py-pkgs)
* [Scientific Computing with Python for beginners](https://github.com/pnavaro/python-notebooks)
* [The Good Research Code Handbook](https://github.com/patrickmineault/codebook)
