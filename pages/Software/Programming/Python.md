...
* ["The Packaging Lifecycle with Poetry", Clinton Roy (Kiwi Pycon X)](https://youtu.be/Au2t6VfY2_M)
...
* [Kedro: Micro-packaging](https://kedro.readthedocs.io/en/stable/nodes_and_pipelines/micro_packaging.html)
* [Kedro: Package a project](https://kedro.readthedocs.io/en/stable/tutorial/package_a_project.html)
* [How To Publish Your First Python Package — It’s Not That Hard](https://betterprogramming.pub/how-to-publish-your-first-python-package-its-not-that-hard-6202f74f5954)
* [How to Publish Python Modules](https://python.plainenglish.io/publishing-python-modules-b38026a51665)
* [Publish Your Python Code to PyPI in 5 Simple Steps](https://builtin.com/data-science/how-to-publish-python-code-pypi)
* [How to set up a perfect Python project](https://sourcery.ai/blog/python-best-practices/)

### Templates

* [Hypermodern Python](https://cookiecutter-hypermodern-python.readthedocs.io/en/2022.6.3.post1/index.html)
...
* [4 Python type checkers to keep your code clean](https://www.infoworld.com/article/3575079/4-python-type-checkers-to-keep-your-code-clean.html)
