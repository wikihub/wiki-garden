...
## Jenkins on Docker
* [Jenkins on Docker](https://github.com/jenkinsci/docker#preinstalling-plugins)
...
* [Getting started](https://github.com/jenkinsci/configuration-as-code-plugin/blob/master/README.md)
