...
* [k8s.pascaliske.dev](https://github.com/pascaliske/infrastructure)
...
* [Templating YAML with code](https://learnk8s.io/templating-yaml-with-code)
...
* [Telepresence: Getting started](https://www.telepresence.io/docs/latest/quick-start/)
